...
- _[Le catalogue des symbolisations PLU](/PLU/Catalogue_Symbolisation_CNIG_PLU.pdf)_ est un récapitulatif illustré des préconisations de symbologie au format PDF. Pour chaque type de zone, sous-code de prescription ou sous-code d'information, il indique les spécifications des symboles recommandés sous une forme littérale pouvant être déclinée pour d'autres contextes.
