...
<qgis simplifyAlgorithm="0" simplifyMaxScale="1" version="3.10.3-A Coruña" labelsEnabled="0" maxScale="0" minScale="1e+08" simplifyLocal="1" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" readOnly="0" simplifyDrawingHints="1">
 ...
 <renderer-v2 enableorderby="0" forceraster="0" type="RuleRenderer" symbollevels="1">
  <rules key="{4272325f-d001-4fe1-8e13-935daaf030f1}">
   <rule filter="TYPEINF = '02'" label="02 - Zone d'aménagement concerté" key="{12ff8092-d1f7-4cfb-a08e-251291081e18}" symbol="0"/>
   <rule filter="TYPEINF = '03'" label="03 - Zone de préemption dans un espace naturel sensible" key="{070ffe9b-b209-4ec1-971b-7d4b7fe3dcb8}" symbol="1"/>
   <rule filter="TYPEINF = '04' AND STYPEINF = '00'" label="04-00 - Périmètre de droit de préemption urbain" key="{ac4877c8-06d2-4f50-ba4e-3359a0fd0a4b}" symbol="2"/>
   <rule filter="TYPEINF = '04' AND STYPEINF = '01'" label="04-01 - Périmètre de droit de préemption urbain renforcé" key="{7db2e4c0-aad0-4c50-9f4e-895a8e7bd8cc}" symbol="3"/>
   <rule filter="TYPEINF = '05'" label="05 - Zone d'aménagement différé" key="{bed37570-aa35-4074-963e-7e1753ff4c6c}" symbol="4"/>
   <rule filter="TYPEINF = '07'" label="07 - Périmètre de développement prioritaire économie d'énergie" key="{e59882eb-1dc1-4a2b-bdfd-07108bf1e59f}" symbol="5"/>
   <rule filter="TYPEINF = '08'" label="08 - Périmètre forestier" key="{48c49647-6bb8-4e10-9e6f-bae9ec50213f}" symbol="6"/>
   <rule filter="TYPEINF = '09'" label="09 - Périmètre minier de concession pour l'exploitation ou le stockage" key="{cad99175-2012-4211-81eb-6124ec71168f}" symbol="7"/>
   <rule filter="TYPEINF = '10'" label="10 - Zone de recherche et d'exploitation de carrière" key="{f1283c9d-869e-41e2-aa5f-2930b667e012}" symbol="8"/>
   <rule filter="TYPEINF = '11'" label="11 - Périmètre des zones délimitées – divisions foncières soumises à déclaration préalable" key="{c314a643-87d4-42c2-bdff-44f66104515a}" symbol="9"/>
   <rule filter="TYPEINF = '12'" label="12 - Périmètre de sursis à statuer" key="{9393c460-7396-4e6d-a98c-ac75fbc245a3}" symbol="10"/>
   <rule filter="TYPEINF = '13'" label="13 - Secteur de programme d'aménagement d’ensemble" key="{9ca826dc-a7cf-446f-9b04-fc5342b1096b}" symbol="11"/>
   <rule filter="TYPEINF = '14'" label="14 - Périmètre de voisinage d'infrastructure de transport terrestre" key="{05bd975c-8b08-4422-a06b-a6b16a8f54e2}" symbol="12"/>
   <rule filter="TYPEINF = '16'" label="16 - Site archéologique" key="{f3feb7ae-f705-4b58-806e-cc97fbb2f28a}" symbol="13"/>
   <rule filter="TYPEINF = '17'" label="17 - Zone à risque d'exposition au plomb" key="{fbdfb09e-a06e-48e3-9bee-5a0829d6c6f6}" symbol="14"/>
   <rule filter="TYPEINF = '19'" label="19 - Assainissement et déchets" key="{c1e66eb2-f15d-4002-af25-81219d4cedd0}" symbol="15"/>
   <rule filter="TYPEINF = '20'" label="20 - Règlement local de publicité" key="{dd68b5fd-2ecb-4cce-b1da-c3928f5809bd}" symbol="16"/>
   <rule filter="TYPEINF = '21'" label="21 - Projet PPRN et PPRM" key="{5d71c4f4-baf7-4d1d-a0f0-fbd3051b671d}" symbol="17"/>
   <rule filter="TYPEINF = '22'" label="22 - Protection des rives des plans d'eau en zone de montagne" key="{37506ed7-1dff-4aee-8b1e-f14128087401}" symbol="18"/>
   <rule filter="TYPEINF = '23'" label="23 - Arrêté du préfet coordonnateur de massif" key="{db644bcc-c0e4-4b6a-b6b4-43a9fb8398ba}" symbol="19"/>
   <rule filter="TYPEINF = '25'" label="25 - Périmètre de protection des espaces agricoles et naturels péri-urbains" key="{6dbbf468-5fe6-4e76-8b33-7fd98668b388}" symbol="20"/>
   <rule filter="TYPEINF = '27'" label="27 - Plan d'exposition au bruit des aérodromes" key="{dba748a3-cdf5-4994-bc06-aa8dad42d364}" symbol="21"/>
   <rule filter="TYPEINF = '30'" label="30 - Périmètre PUP" key="{d4644e9e-857a-461d-b95f-f44f69228d02}" symbol="22"/>
   <rule filter="TYPEINF = '31'" label="31 - Périmètre patrimonial d'exclusion des matériaux et énergies renouvelables pris par délibération" key="{eeb67f46-e3f5-4a7d-ab67-b414802abc09}" symbol="23"/>
   <rule filter="TYPEINF = '32'" label="32 - Secteur à fiscalité particulière (taxe d'aménagement)" key="{9c450e2a-a1d2-4654-8766-7e3724e31d8f}" symbol="24"/>
   <rule filter="TYPEINF = '33'" label="33 - Droit de préemption commercial" key="{475d87ad-44ec-4c7c-976c-266b12585b8a}" symbol="25"/>
   <rule filter="TYPEINF = '34'" label="34 - Périmètre d'opération d’intérêt national" key="{66bd7f57-a082-48ba-9b1f-417f3189a60b}" symbol="26"/>
   <rule filter="TYPEINF = '35'" label="35 - Périmètre de secteur affecté par un seuil minimal de densité" key="{95446248-61ef-461e-b793-7aec22a3b59d}" symbol="27"/>
   <rule filter="TYPEINF = '36'" label="36 - Schémas d'aménagement de plage" key="{c13e9c85-17b8-498c-a9d5-d325bee72fe0}" symbol="28"/>
   <rule filter="TYPEINF = '37'" label="37 - Bois ou forêts relevant du régime forestier" key="{0b44e5f2-0609-440d-b777-cecb6c2e6727}" symbol="29"/>
   <rule filter="TYPEINF = '38'" label="38 - Secteurs d'informations sur les sols" key="{ada02dbe-6603-4422-be31-bd48929cd933}" symbol="30"/>
   <rule filter="TYPEINF = '39'" label="39 - Périmètres de projets AFUP" key="{45b4ef93-cd43-4897-8bbb-6d51a25e5a1f}" symbol="31"/>
   <rule filter="TYPEINF = '40' AND STYPEINF = '01'" label="40-01 - Périmètre d'un bien inscrit au patrimoine mondial" key="{840c592d-82fd-4b86-8a4d-b9df300c6343}" symbol="32"/>
   <rule filter="TYPEINF = '40' AND STYPEINF = '02'" label="40-02 - Zone tampon d'un bien inscrit au patrimoine mondial" key="{89f99f6e-9063-4266-b280-597364971718}" symbol="33"/>
   <rule filter="TYPEINF = '41'" label="41 - Bandes non constructibles de part et d'autre des voies" key="{695a9a80-9173-4b2a-8227-336bd57dd05f}" symbol="34"/>
   <rule filter="TYPEINF = '97'" label="97 - Périmètre d'application d'une pièce écrite territorialisée relative aux annexes" key="{ef579be2-8072-445b-a259-307e5eefb761}" symbol="35"/>
   <rule filter="TYPEINF = '98'" label="98 - Périmètre d'annulation partielle du document d'urbanisme" key="{3cbe98f7-4902-4c8d-9ada-23a1f39fa586}" symbol="36"/>
   <rule filter="TYPEINF = '99'" label="99 - Autre" key="{7608d5f8-1ce8-4d26-9408-c5a7af16c3cd}" symbol="37"/>
  ...
  <symbols>
   ...
   <symbol name="11" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
    <layer enabled="1" pass="0" locked="0" class="LinePatternFill">
     ...
     <symbol name="@11@0" type="line" clip_to_extent="1" alpha="1" force_rhr="0">
   ...
   <symbol name="12" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
    <layer enabled="1" pass="1" locked="0" class="PointPatternFill">
     ...
     <symbol name="@12@0" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
      <layer enabled="1" pass="0" locked="0" class="FontMarker">
       <prop k="angle" v="0"/>
       <prop k="chr" v="l"/>
   ...
   <symbol name="14" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
    <layer enabled="1" pass="2" locked="0" class="PointPatternFill">
     ...
     <symbol name="@14@0" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
      <layer enabled="1" pass="0" locked="0" class="FontMarker">
       <prop k="angle" v="0"/>
       <prop k="chr" v="b"/>
   ...
   <symbol name="16" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
    ...
    <layer enabled="1" pass="0" locked="0" class="PointPatternFill">
     ...
     <symbol name="@16@2" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
      <layer enabled="1" pass="0" locked="0" class="SimpleMarker">
       <prop k="angle" v="0"/>
       <prop k="color" v="255,85,0,0"/>
       <prop k="horizontal_anchor_point" v="1"/>
   ...
   <symbol name="17" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
    <layer enabled="1" pass="1" locked="0" class="LinePatternFill">
     ...
     <symbol name="@17@0" type="line" clip_to_extent="1" alpha="1" force_rhr="0">
      <layer enabled="1" pass="0" locked="0" class="SimpleLine">
       <prop k="capstyle" v="square"/>
       <prop k="customdash" v="5;2"/>
       <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
   ...
   <symbol name="19" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
    ...
    <layer enabled="1" pass="2" locked="0" class="MarkerLine">
     ...
     <symbol name="@19@1" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
      <layer enabled="1" pass="0" locked="0" class="SimpleMarker">
       <prop k="angle" v="0"/>
   ...
   <symbol name="20" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
    <layer enabled="1" pass="1" locked="0" class="LinePatternFill">
     ...
     <symbol name="@20@0" type="line" clip_to_extent="1" alpha="1" force_rhr="0">
      <layer enabled="1" pass="0" locked="0" class="SimpleLine">
       <prop k="capstyle" v="square"/>
       <prop k="customdash" v="5;2"/>
       <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
   ...
   <symbol name="21" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
    <layer enabled="1" pass="2" locked="0" class="PointPatternFill">
     ...
     <symbol name="@21@0" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
      <layer enabled="1" pass="0" locked="0" class="FontMarker">
       <prop k="angle" v="0"/>
       <prop k="chr" v="j"/>
   ...
   <symbol name="22" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
    <layer enabled="1" pass="0" locked="0" class="LinePatternFill">
     ...
     <symbol name="@22@0" type="line" clip_to_extent="1" alpha="1" force_rhr="0">
      <layer enabled="1" pass="0" locked="0" class="SimpleLine">
       <prop k="capstyle" v="square"/>
       <prop k="customdash" v="5;2"/>
       <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
   ...
   <symbol name="24" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
    <layer enabled="1" pass="2" locked="0" class="PointPatternFill">
     ...
     <symbol name="@24@0" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
      <layer enabled="1" pass="0" locked="0" class="FontMarker">
       <prop k="angle" v="0"/>
       <prop k="chr" v="°"/>
   ...
   <symbol name="3" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
    ...
    <layer enabled="1" pass="0" locked="0" class="PointPatternFill">
     ...
     <symbol name="@3@2" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
      <layer enabled="1" pass="0" locked="0" class="FontMarker">
       <prop k="angle" v="0"/>
       <prop k="chr" v="U"/>
   ...
   <symbol name="31" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
    <layer enabled="1" pass="1" locked="0" class="LinePatternFill">
     ...
     <symbol name="@31@0" type="line" clip_to_extent="1" alpha="1" force_rhr="0">
      <layer enabled="1" pass="0" locked="0" class="SimpleLine">
       <prop k="capstyle" v="square"/>
       <prop k="customdash" v="5;2"/>
       <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
   ...
   <symbol name="34" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
    <layer enabled="1" pass="0" locked="0" class="LinePatternFill">
     ...
     <symbol name="@34@0" type="line" clip_to_extent="1" alpha="1" force_rhr="0">
      <layer enabled="1" pass="0" locked="0" class="SimpleLine">
       <prop k="capstyle" v="square"/>
       <prop k="customdash" v="5;2"/>
       <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
   ...
   <symbol name="4" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
    <layer enabled="1" pass="1" locked="0" class="PointPatternFill">
     ...
     <symbol name="@4@0" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
      <layer enabled="1" pass="0" locked="0" class="FontMarker">
       <prop k="angle" v="0"/>
       <prop k="chr" v="="/>
   ...
   <symbol name="6" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
    <layer enabled="1" pass="2" locked="0" class="PointPatternFill">
     ...
     <symbol name="@6@0" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
      <layer enabled="1" pass="0" locked="0" class="FontMarker">
       <prop k="angle" v="0"/>
       <prop k="chr" v="▓"/>
       <prop k="color" v="38,140,0,255"/>
