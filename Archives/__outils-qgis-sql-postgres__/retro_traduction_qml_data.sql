...
INSERT INTO s_cnig_docurba.qml_traduction_prop (symbol_class, symbol_prop, traduction, unite_implicite, b_trad_value) VALUES
    ...
    ('FontMarker', 'color', 'couleur de remplissage', NULL, false),
    ...
    ('FontMarker', 'outline_color', 'couleur de trait', NULL, false),
    ...
    ('MarkerLine', 'placement', 'emplacement', NULL, true),
    ...
    ('SimpleFill', 'color', 'couleur de remplissage', NULL, false),
    ('SimpleFill', 'outline_color', 'couleur de trait', NULL, false),
    ...
    ('SimpleLine', 'line_color', 'couleur', NULL, false),
    ...
    ('SimpleMarker', 'color', 'couleur de remplissage', NULL, false),
    ...
    ('SimpleMarker', 'outline_color', 'couleur de trait', NULL, false),
...
INSERT INTO s_cnig_docurba.qml_traduction_value (symbol_class, symbol_prop, symbol_value, traduction) VALUES
    ...
    ('MarkerLine', 'placement', 'centralpoint', 'sur le point central'),
