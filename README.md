...
* les préconisations de symbolisation produites par le SG5 pour harmoniser la représentation cartographique des données standardisées :
  ...
  * [préconisations](/SUP/Catalogue_Symbolisation_CNIG_SUP.pdf) associées au standard **SUP**,synthétisées dans la [Planche Symbolisation des **SUP**](/SUP/Planche_Symbolisation_CNIG_SUP.pdf)
